namespace MyApplication
{
	public partial class MainForm : System.Windows.Forms.Form
	{
		...
		private void MainForm_Load(object sender, System.EventArgs e)
		{
            ...
            // **************************************************
            // *************************
            editBooksToolStripMenuItem.Visible =
                Infrastructure.Utility.AuthenticatedUser.IsAdmin;
		}
        ...
        private void bookListToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
            BooksList booksList = new BooksList();
            booksList.ShowDialog();
        }

        private void editBooksToolStripMenuItem_Click(object sender, System.EventArgs e)
        {
            Admin.AddBooksForm addBooksForm =
                new Admin.AddBooksForm();
